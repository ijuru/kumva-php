 ...
 */
?>    
<p>Possessives modify a noun to describe it's ownership by, or relationship to, another noun.</p>
...
<ul>
	<li><span lang="rw">umutwe wayo</span> - it's head</li>
	<li><span lang="rw">ikirengi cyayo</span> - it's foot</li>
	<li><span lang="rw">amahembe yayo</span> - it's horns</li>
	<li><span lang="rw">ubwoya bwayo</span> - it's hair</li>
	<li><span lang="rw">ukuboko kwayo</span> - it's front leg (lit. arm)</li>
</ul>
...
<table class="grammar">
	...
	<tr>
		...
		<td><span lang="rw">umwana wawo</span> - it's child</td>
		<td><span lang="rw">igitabo cyawo</span> - it's book</td>
		<td><span lang="rw">inka yawo</span> - it's cow</td>
	</tr>
	<tr>
		<td>4</td>
		<td><span lang="rw"><?php ku_query('imi*', 'imi-'); ?></span>, <span lang="rw"><?php ku_query('imy*', 'imy-'); ?></span></td>
		<td><span lang="rw">-yo</span></td>
		<td><span lang="rw">umwana wayo</span> - it's child</td>
		<td><span lang="rw">igitabo cyayo</span> - it's book</td>
		<td><span lang="rw">inka yayo</span> - it's cow</td>
	</tr>
	<tr>
		<td>5</td>
		<td><span lang="rw"><?php ku_query('i*', 'i-'); ?></span>, <span lang="rw"><?php ku_query('iri*', 'iri-'); ?></span></td>
		<td><span lang="rw">-ryo</span></td>
		<td><span lang="rw">umwana waryo</span> - it's child</td>
		<td><span lang="rw">igitabo cyaryo</span> - it's book</td>
		<td><span lang="rw">inka yaryo</span> - it's cow</td>
	</tr>
	<tr>
		<td>6</td>
		<td><span lang="rw"><?php ku_query('ama*', 'ama-'); ?></span>, <span lang="rw"><?php ku_query('am*', 'am-'); ?></span></td>
	...
	<tr>
		...
		<td><span lang="rw">umwana wacyo</span> - it's child</td>
		<td><span lang="rw">igitabo cyacyo</span> - it's book</td>
		<td><span lang="rw">inka yacyo</span> - it's cow</td>
	</tr>
	<tr>
		<td>8</td>
		<td><span lang="rw"><?php ku_query('ibi*', 'ibi-'); ?></span>, <span lang="rw"><?php ku_query('iby*', 'ibi-'); ?></span></td>
		<td><span lang="rw">-byo</span></td>
		<td><span lang="rw">umwana wabyo</span> - it's child</td>
		<td><span lang="rw">igitabo cyabyo</span> - it's book</td>
		<td><span lang="rw">inka yabyo</span> - it's cow</td>
	</tr>
	<tr>
		<td>9</td>
		<td rowspan="2"><span lang="rw"><?php ku_query('i*', 'i-'); ?></span>, <span lang="rw"><?php ku_query('in*', 'in-'); ?></span>, <span lang="rw"><?php ku_query('inz*', 'inz-'); ?></span></td>
	...
	<tr>
		...
		<td><span lang="rw">umwana wazo</span> - it's child</td>
		<td><span lang="rw">igitabo cyazo</span> - it's book</td>
		<td><span lang="rw">inka yazo</span> - it's cow</td>
	</tr>
	<tr>
		<td>11</td>
		<td><span lang="rw"><?php ku_query('uru*', 'uru-'); ?></span>, <span lang="rw"><?php ku_query('urw*', 'urw-'); ?></span></td>
		<td><span lang="rw">-rwo</span></td>
		<td><span lang="rw">umwana warwo</span> - it's child</td>
		<td><span lang="rw">igitabo cyarwo</span> - it's book</td>
		<td><span lang="rw">inka yarwo</span> - it's cow</td>
	</tr>
	<tr>
		<td>12</td>
		<td><span lang="rw"><?php ku_query('aka*', 'aka-'); ?></span>, <span lang="rw"><?php ku_query('ak*', 'ak-'); ?></span>, <span lang="rw"><?php ku_query('aga*', 'aga-'); ?></span></td>
		<td><span lang="rw">-ko</span></td>
		<td><span lang="rw">umwana wako</span> - it's child</td>
		<td><span lang="rw">igitabo cyako</span> - it's book</td>
		<td><span lang="rw">inka yako</span> - it's cow</td>
	</tr>
	<tr>
		<td>13</td>
		<td><span lang="rw"><?php ku_query('utu*', 'utu-'); ?></span>, <span lang="rw"><?php ku_query('utw*', 'utw-'); ?></span>, <span lang="rw"><?php ku_query('udu*', 'udu-'); ?></span></td>
		<td><span lang="rw">-two</span></td>
		<td><span lang="rw">umwana watwo</span> - it's child</td>
		<td><span lang="rw">igitabo cyatwo</span> - it's book</td>
		<td><span lang="rw">inka yatwo</span> - it's cow</td>
	</tr>
	<tr>
		<td>14</td>
		<td><span lang="rw"><?php ku_query('ubu*', 'ubu-'); ?></span>, <span lang="rw"><?php ku_query('ubw*', 'ubw-'); ?></span></td>
		<td><span lang="rw">-bwo</span></td>
		<td><span lang="rw">umwana wabwo</span> - it's child</td>
		<td><span lang="rw">igitabo cyabwo</span> - it's book</td>
		<td><span lang="rw">inka yabwo</span> - it's cow</td>
	</tr>
	<tr>
		<td>15</td>
		<td><span lang="rw"><?php ku_query('uku*', 'uku-'); ?></span>, <span lang="rw"><?php ku_query('ukw*', 'ukw-'); ?></span>, <span lang="rw"><?php ku_query('ugu*', 'ugu-'); ?></span></td>
		<td><span lang="rw">-kwo</span></td>
		<td><span lang="rw">umwana wakwo</span> - it's child</td>
		<td><span lang="rw">igitabo cyakwo</span> - it's book</td>
		<td><span lang="rw">inka yakwo</span> - it's cow</td>
	</tr>
	<tr>
		<td>16</td>
		<td><span lang="rw"><?php ku_query('aha*', 'aha-'); ?></span>, <span lang="rw"><?php ku_query('ah*', 'ah-'); ?></span></td>
		<td><span lang="rw">-ho</span></td>
		<td><span lang="rw">umwana waho</span> - it's child</td>
		<td><span lang="rw">igitabo cyaho</span> - it's book</td>
		<td><span lang="rw">inka yaho</span> - it's cow</td>
	</tr>
</table>
