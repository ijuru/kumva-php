...
$history = Dictionary::getSearchService()->getSearchHistory($remoteAddr, $source, $showOnlyMisses, $paging);
...
?>
    <tr <?php echo ($results == 0) ? 'style="background-color:#FDD"' : ''; ?>>
        ...
        <td><a href="searches.php?who=<?php echo urlencode($search['remoteaddr']); ?>"><?php echo $search['remoteaddr']; ?></a></td>
